...
import (
	...
	"github.com/facundocenteno/bookstore_oauth-go/oauth/errors"
...
const (
	...
	parameterAccesToken = "access_token"
)
...
func AuthenticateRequest(request *http.Request) *errors.RestErr {
	...
	accessTokenId := strings.TrimSpace(request.URL.Query().Get(parameterAccesToken))
	if accessTokenId == "" {
		return nil
	}
